...
public class CharacteristicsConcordanceManager extends AbstractConcordanceManager<CharacteristicsConcordanceBean> {
     ...
     */
	public CharacteristicsConcordanceManager() throws URISyntaxException, IOException {
	 ...
	 */
	@Override
	protected Map<String, CharacteristicsConcordanceBean> initBeanMap(
			HeaderColumnNameTranslateMappingStrategy<CharacteristicsConcordanceBean> strat,
			CSVReader reader) {
	 ...
	 */
	@Override
	protected Class<CharacteristicsConcordanceBean> getBeanClass() {
		return CharacteristicsConcordanceBean.class;
	}
